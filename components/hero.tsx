...
import { RotatingEditIcon } from '@/components/rotating-edit-icon'
  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div id="features" className="max-w-[1200px] mx-auto px-4 pb-16">
        ...
        <div className="bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-950/20 dark:to-teal-950/20 rounded-2xl p-8 border">
...
function Feature({ title, desc, icon }: { title: string; desc: string; icon: React.ReactNode }) {
  return (
    <div className="rounded-xl border bg-white/70 backdrop-blur p-6 hover:shadow-lg transition-all hover:scale-105">
